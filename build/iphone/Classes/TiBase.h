...
// in simulator we redefine to format for Ti_TeamTaskManager Developer console
...
{\
	NSString * exceptionName = [@"org.ti_teamtaskmanager." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ti_teamtaskmanager";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITi_TeamTaskManagerNativeItemNone = -1, 
	UITi_TeamTaskManagerNativeItemSpinner = -2,
	UITi_TeamTaskManagerNativeItemProgressBar = -3,
	
	UITi_TeamTaskManagerNativeItemSlider = -4,
	UITi_TeamTaskManagerNativeItemSwitch = -5,
	UITi_TeamTaskManagerNativeItemMultiButton = -6,
	UITi_TeamTaskManagerNativeItemSegmented = -7,
	
	UITi_TeamTaskManagerNativeItemTextView = -8,
	UITi_TeamTaskManagerNativeItemTextField = -9,
	UITi_TeamTaskManagerNativeItemSearchBar = -10,
	
	UITi_TeamTaskManagerNativeItemPicker = -11,
	UITi_TeamTaskManagerNativeItemDatePicker = -12,
	
	UITi_TeamTaskManagerNativeItemInfoLight = -13,
	UITi_TeamTaskManagerNativeItemInfoDark = -14,
	
	UITi_TeamTaskManagerNativeItemDisclosure = -15,
	
	UITi_TeamTaskManagerNativeItemContactAdd = -16
};
