 ...
 * Copyright (c) 2009-2011 by Ti_TeamTaskManager, Inc. All Rights Reserved.
...
//@interface Ti_TeamTaskManagerObject : NSObject
//@end

@interface Ti_TeamTaskManagerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ti_TeamTaskManagerObject class]])
		{
			for (NSString *key in [[(Ti_TeamTaskManagerObject*)o modules] allKeys])
			{
